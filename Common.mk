...
LUA51_DIR        = $(THIRD_PARTY_DIR)/lua-5.1.4
...
OPENAL_DIR       = $(THIRD_PARTY_DIR)/openal-soft
ZLIB_DIR         = $(THIRD_PARTY_DIR)/zlib-1.2.5
BOX2D_DIR        = $(THIRD_PARTY_DIR)/Box2D-2.2.1
LIBPNG_DIR       = $(THIRD_PARTY_DIR)/libpng-1.4.22
