...
#elif defined(LTTIZENX86)
#   include <curl/curlbuild_tizen_x86.h>
#elif defined(LTTIZENARM)
#   include <curl/curlbuild_tizen_arm.h>
#else
#   error "target not supported"
#endif
